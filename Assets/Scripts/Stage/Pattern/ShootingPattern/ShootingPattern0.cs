...
public class ShootingPattern0 : MonoBehaviour, IPattern
{
    ...
    [SerializeField] private float obstacleInterval = 30f;
    [SerializeField] private float obstacleXPreset = 5f;
    ...
    public void Initialize(Player player)
    {
        ...
        {
            obstacle.transform.localPosition = new Vector3(obstacleXPreset + obstacleInterval * count++, 0, 0);
        }
